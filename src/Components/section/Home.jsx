    ...
    >
      ...
      <div className="text-center z-10 px-4">
        ...
        <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
          Full-stack web developer passionate about building fast, user-friendly
          applications using the MERN stack. Currently learning at AlmaBetter
          while pursuing a BBA in Management.
        </p>
